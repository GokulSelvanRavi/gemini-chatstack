...
serve(async (req) => {
  ...
  try {
    ...
    console.log("Calling Google Gemini AI with prompt:", prompt);
    ...
    // Get authorization header to store message
    ...
    console.log("Successfully generated and stored AI response");
